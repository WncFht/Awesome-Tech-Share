...
# 论文阅读
- [Spanner 论文阅读](https://zhuanlan.zhihu.com/p/2052141281200051827)
- [DouZero+：基于对手建模和教练引导学习改进斗地主 AI](https://arxiv.org/abs/2204.02558) — 论文在 DouZero 基础上加入对手建模和教练引导学习，以改进斗地主智能体训练。 <!-- 待人工确认: accessible; record-id: 73ab3505aae50402 -->
