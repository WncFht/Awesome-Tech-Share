...
# 项目
- [AutoSci - Read, think, experiment, write, evolve — the AI research agent with memory that compounds across every project.](https://github.com/skyllwt/AutoSci)
...
- [OpenAPI spec 输入 → N 种 Agent 可消费格式输出](https://github.com/koriyoshi2041/agentify   )
...
- [分享一个快速入门具身智能的一个仓库](https://github.com/TianxingChen/Embodied-AI-Guide)
